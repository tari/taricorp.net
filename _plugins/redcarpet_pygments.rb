# Monkey-patch the Jekyll Markdown converter to add redcarpet-pygments, adding
# the lineanchors option to Pygments invocation.
module Jekyll
  module Converters
...
# Parsers for redcarpet-pygments
module Jekyll
  module Converters
    class Markdown
